...
In this document, we will write functions that will manipulate, process, and plot data from a [census API]("https://data.census.gov/app/mdat/#"). The following document is divided into parts: Data Processing, Obtaining Person Level Records, and Writing a Generic Function for Summarizing. For each major function, there will be a sample function call. 
...
### Helper Funtion to Determine Time Variable Mid Points
